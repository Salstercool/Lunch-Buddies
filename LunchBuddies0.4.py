...
def LocationSettings():
    ...
    location2 = input("What city do you live in: ")
    print("thank you, returning you to the main menu")
    print("------------------------------------------")
    MainMenu()
...
def Friends():
    print("Choose if you'd like to see the list of fiends or add friends")

    selection = input("""
                      A: See list of my frienda
                      B: Add a friend to the list
                      Q: Back to menu
                      Please enter your choice: """)
    ...
    if selection == "A" or selection =="a":
        ...
        c = input("What is your friend's username: ")
        friendlist.append(c)
        Friends()
    elif selection =="Q" or selection =="q":
        MainMenu()
    else:
        print("You must only select something")
        print("Please try again")
def GroupChats():
    print("*")
